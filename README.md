...
| [P95](/desempenho/p95.sql) | Calcula o percentil 95 do tempo de resposta por API |
...
[<- Querys Resiliência das APIs](https://github.com/Gerencia-de-Telemetria-OpenFinance/querys)